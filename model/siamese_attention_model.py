...
class SiameAttModel:
  ...
  def build_template(self):
    def exemplar_attention(feature, attention):
      return attach_attention_module(feature, attention_module=attention)

    attention = self.model_config['attention_module']
    self.templates = exemplar_attention(self.exemplar_embeds, attention)
